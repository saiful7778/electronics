  ...
  <head>
    ...
    <style>
      ...
      * {
      ...
      .button_section div button span {
        z-index: 10;
        top: -30px;
        left: -10px;
        display: block;
  ...
  <body>
    <div class="container">
      <div class="logo_section">
        ...
        <div class="text">
          <h1>DTR - Home automation</h1>
          <p>created by Saiful Islam</p>
        </div>
      </div>
      <div id="show_Data"><span id="show_Status"></span></div>
      <div class="button_section">
        <div>
          <button class="btn" id="btn-1">Switch 1<span id="btn-1-status">off</span></button>
        </div>
        <div>
          <button class="btn" id="btn-2">Switch 2<span id="btn-2-status"></span></button>
        </div>
        <div>
          <button class="btn" id="btn-3">Switch 3<span id="btn-3-status"></span></button>
        </div>
        <div>
          <button class="btn" id="btn-4">Switch 4<span id="btn-4-status"></span></button>
        </div>
      </div>
    </div>
    <script>
      ...
      let btn_status_1 = document.getElementById("btn-1-status");
      let btn_status_2 = document.getElementById("btn-2-status");
      let btn_status_3 = document.getElementById("btn-3-status");
      let btn_status_4 = document.getElementById("btn-4-status");
      ...
      if(btn_status_3.innerHTML == "off"){btn_status_3.classList.add("status_style");}else{btn_status_3.classList.remove("status_style");}
      if(btn_status_4.innerHTML == "off"){btn_status_4.classList.add("status_style");}else{btn_status_4.classList.remove("status_style");}
      btn_1.addEventListener("click", () => {
        if (btn_status_1.innerHTML == "on") {
          let data = '{"LED_1":'+0+'}';
          connection.send(data);
          btn_status_1.innerHTML = "off";
          btn_status_1.classList.add("status_style");
        } else {
          let data = '{"LED_1":'+1+'}';
          connection.send(data);
          btn_status_1.innerHTML = "on";
          btn_status_1.classList.remove("status_style");
        };
      });
      btn_2.addEventListener("click", () => {
        if (btn_status_2.innerHTML == "on") {
          let data = '{"LED_2":'+0+'}';
          connection.send(data);
          btn_status_2.innerHTML = "off";
          btn_status_2.classList.add("status_style");
        } else {
          let data = '{"LED_2":'+1+'}';
          connection.send(data);
          btn_status_2.innerHTML = "on";
          btn_status_2.classList.remove("status_style");
        }
      });
      btn_3.addEventListener("click", () => {
        if (btn_status_3.innerHTML == "on") {
          let data = '{"LED_3":'+0+'}';
          connection.send(data);
          btn_status_3.innerHTML = "off";
          btn_status_3.classList.add("status_style");
        } else {
          let data = '{"LED_3":'+1+'}';
          connection.send(data);
          btn_status_3.innerHTML = "on";
          btn_status_3.classList.remove("status_style");
        }
      });
      btn_4.addEventListener("click", () => {
        if (btn_status_4.innerHTML == "on") {
          let data = '{"LED_4":'+0+'}';
          connection.send(data);
          btn_status_4.innerHTML = "off";
          btn_status_4.classList.add("status_style");
        } else {
          let data = '{"LED_4":'+1+'}';
          connection.send(data);
          btn_status_4.innerHTML = "on";
          btn_status_4.classList.remove("status_style");
        }
      });
    </script>
  </body>
